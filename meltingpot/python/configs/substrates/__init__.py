...
SUBSTRATES: Set[str] = frozenset({
    ...
    'chicken_in_the_matrix__repeated_large',
    'chicken_in_the_matrix__repeated_medium',
    'chicken_in_the_matrix__repeated_obstacle',
    'chicken_in_the_matrix__repeated_small',
    ...
    'prisoners_dilemma_in_the_matrix__repeated_large',
    'prisoners_dilemma_in_the_matrix__repeated_medium',
    'prisoners_dilemma_in_the_matrix__repeated_obstacle',
    'prisoners_dilemma_in_the_matrix__repeated_small',
    'prisoners_dilemma_in_the_matrix__repeated',
    'pure_coordination_in_the_matrix__arena',
    'pure_coordination_in_the_matrix__repeated_large',
    'pure_coordination_in_the_matrix__repeated_medium',
    'pure_coordination_in_the_matrix__repeated_obstacle',
    'pure_coordination_in_the_matrix__repeated_small',
    ...
    'stag_hunt_in_the_matrix__repeated_large',
    'stag_hunt_in_the_matrix__repeated_medium',
    'stag_hunt_in_the_matrix__repeated_obstacle',
    'stag_hunt_in_the_matrix__repeated_small',
