...
def get_config(
    substrate_name: str = "stag_hunt_in_the_matrix__repeated_obstacle",
...
def main():
  ...
  # parameters
  save_path = '/home/yuxin/meltingpot/MARL/SP_logs/sh5o'
  checkpoints_path = '/home/yuxin/meltingpot/MARL/SP_checkpoints/sh5o'
  log_path = '/home/yuxin/meltingpot/MARL/SP_outputs/sh5o.txt'
  checkpoint_freq = 125
  num_gens = 25
